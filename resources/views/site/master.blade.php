...
================================================== -->
  ...
  <!-- FontAwesome -->
  <link rel="stylesheet" href="{{asset('siteasset/plugins/fontawesome/css/all.min.css')}}">
  <!-- Animation -->
  <link rel="stylesheet" href="{{asset('siteasset/plugins/animate-css/animate.css')}}">
  <!-- slick Carousel -->
  <link rel="stylesheet" href="{{asset('siteasset/plugins/slick/slick.css')}}">
  <link rel="stylesheet" href="{{asset('siteasset/plugins/slick/slick-theme.css')}}">
  <!-- Colorbox -->
  <link rel="stylesheet" href="{{asset('siteasset/plugins/colorbox/colorbox.css')}}">
  <!-- Template styles-->
        ...
        <div class="row">
          <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="logo">
                    <a class="d-block" href="{{ route('site.index') }}">
                      <img loading="lazy" src="{{ asset('siteasset/images/logo.png')}}" alt="Constra">
                    </a>
                </div><!-- logo end -->
                    ...
                    <ul class="nav navbar-nav ml-auto align-items-center">
                      ...
                      <li class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="{{ route('site.teams') }}">Our People</a></li>
                            <li><a href="{{ route('site.testimonials') }}">Testimonials</a></li>
...
@yield('content')
  ...
  <!-- Bootstrap jQuery -->
  <script src="{{asset('siteasset/plugins/bootstrap/bootstrap.min.js')}}" defer></script>
  <!-- Slick Carousel -->
  <script src="{{asset('siteasset/plugins/slick/slick.min.js')}}"></script>
  <script src="{{asset('siteasset/plugins/slick/slick-animation.min.js')}}"></script>
  <!-- Color box -->
  <script src="{{asset('siteasset/plugins/colorbox/jquery.colorbox.js')}}"></script>
  <!-- shuffle -->
  <script src="{{asset('siteasset/plugins/shuffle/shuffle.min.js')}}" defer></script>


  <!-- Google Map API Key-->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU" defer></script>
  <!-- Google Map Plugin-->
  <script src="{{asset('siteasset/plugins/google-map/map.js')}}" defer></script>
