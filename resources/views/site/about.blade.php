@extends('site.master')
@section('titel','About | '.env('APP_NAME'))
@section('content')

@include('site.part.benner',['titel'=>'About','item'=>'About Us'])
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
          ...
          <div id="page-slider" class="page-slider small-bg">
            @foreach ($images as $image)
                <div class="item" style="background-image:url({{ asset('image/images/'.$image->path) }})">
                    <div class="container">
