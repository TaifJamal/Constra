...
class QuestionController extends Controller
{
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.questions.index')->with('msg', 'Menu restored successfully')->with('type', 'warning');
    }

    public function forcedelete($id)
    {
        Question::onlyTrashed()->find($id)->forcedelete();
        return redirect()->route('admin.questions.index')->with('msg', 'Menu deleted permanintly successfully')->with('type', 'danger');
    }
